...
CREATE TABLE IF NOT EXISTS StorageSvcSchema.StorageRecords (
  ...
  CONSTRAINT storage_facility_id_fk FOREIGN KEY (storage_facility_id) REFERENCES StorageSvcSchema.StorageFacilities(storage_facility_id) ON DELETE NO ACTION ON UPDATE NO ACTION
);